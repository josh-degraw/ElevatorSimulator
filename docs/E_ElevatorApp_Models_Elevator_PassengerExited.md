# Elevator.PassengerExited Event
 

Called when a <a href="T_ElevatorApp_Models_Passenger">Passenger</a> has just left the <a href="T_ElevatorApp_Models_Elevator">Elevator</a>
