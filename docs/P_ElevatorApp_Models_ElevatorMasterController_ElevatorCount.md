# ElevatorMasterController.ElevatorCount Property 
 

The number of elevators currently being tracked. 
Changing this number will change the number of elements in <a href="P_ElevatorApp_Models_ElevatorMasterController_Elevators">Elevators</a>
