# ElevatorMasterController.FloorCount Property 
 

The number of floors currently being tracked. 
Changing this number will change the number of elements in <a href="P_ElevatorApp_Models_ElevatorMasterController_Floors">Floors</a>
