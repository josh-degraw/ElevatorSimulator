...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_ElevatorApp_Models_ModelBase">ElevatorApp.Models.ModelBase</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_ElevatorApp_Util_Statistic_2">ElevatorApp.Util.Statistic</a>(*T*, *T*)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ElevatorApp.Util.SimpleStatistic(T)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_ElevatorApp_Util_Statistics_DecimalStatistic">ElevatorApp.Util.Statistics.DecimalStatistic</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_ElevatorApp_Util_Statistics_DoubleStatistic">ElevatorApp.Util.Statistics.DoubleStatistic</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_ElevatorApp_Util_Statistics_DurationStatistic">ElevatorApp.Util.Statistics.DurationStatistic</a><br />
...
**C#**<br />
``` C#
public abstract class SimpleStatistic<T> : Statistic<T, T>
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>The single calculation type</dd></dl>&nbsp;
The SimpleStatistic(T) type exposes the following members.
...
Constructs a new SimpleStatistic(T) object, with the given collection as the initial values</td></tr></table>&nbsp;
<a href="#simplestatistic(*t*)-class">Back to Top</a>
